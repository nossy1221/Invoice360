...
import QuotationNewTab from './QuotaionsNewTab';
...
const QuotationNewInvoice = () => {
  ...
  >
    <span style={{ fontWeight: 'bold', fontSize: '18px' }}>+</span> Create Quotation
  </Button>
</div>
  ...
  <Modal show={stepModal} onHide={handleCloseModal} size="xl" centered>
    ...
    <Modal.Body>
        ...
        <QuotationNewTab         key={selectedOrder?.id || 'new'} // force remount on different order
...
export default QuotationNewInvoice;