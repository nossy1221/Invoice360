...
import InvoiceNewTab from './InvoiceNewTab';
...
const InvoiceNewInvoice = () => {
  ...
  >
    <span style={{ fontWeight: 'bold', fontSize: '18px' }}>+</span> Create Invoice
  </Button>
</div>
  ...
  <Modal show={stepModal} onHide={handleCloseModal} size="xl" centered>
    ...
    <Modal.Body>
        ...
        <InvoiceNewTab         key={selectedOrder?.id || 'new'} // force remount on different order
...
export default InvoiceNewInvoice;