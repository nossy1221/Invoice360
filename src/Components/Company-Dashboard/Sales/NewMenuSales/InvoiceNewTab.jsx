...
const InvoiceNewTab = ({ onSubmit, initialData, initialStep }) => {
              ...
              {currentTab.items.map((item, idx) => {
                ...
                return (
                  <tr key={idx}>
                    ...
                    <td style={{ border: '1px solid #000', padding: '8px' }}>R{discount.toFixed(2)}</td>
                    <td style={{ border: '1px solid #000', padding: '8px' }}>R{amount.toFixed(2)}</td>
                  </tr>
                );
              })}
            </tbody>
