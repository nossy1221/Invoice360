...
import SalesOrderTab from '../../Sales/MultiStepSalesForm/SalesOrderTab';

const SalesOrderNewTab = ({ onSubmit, initialData, initialStep }) => {
                            ...
                            {filteredItems.map(filteredItem => (
                              ...
                              >
                                ...
                                <div style={{ fontSize: '0.8rem', color: '#666' }}>
                                  {filteredItem.category} - R{filteredItem.price.toFixed(2)}
                                </div>
                              </div>
                            ))}
                          </div>
      ...
      <div style={{ fontFamily: 'Arial, sans-serif', padding: '20px', backgroundColor: 'white' }}>
              ...
              {currentTab.items.map((item, idx) => {
                ...
                return (
                  <tr key={idx}>
                    ...
                    <td style={{ border: '1px solid #000', padding: '8px' }}>R{rate.toFixed(2)}</td>
                    <td style={{ border: '1px solid #000', padding: '8px' }}>{tax}%</td>
                    <td style={{ border: '1px solid #000', padding: '8px' }}>Rate{discount.toFixed(2)}</td>
                    <td style={{ border: '1px solid #000', padding: '8px' }}>Rate{amount.toFixed(2)}</td>
                  </tr>
                );
              })}
            </tbody>
            <tfoot>
              <tr>
                ...
                <td style={{ fontWeight: 'bold', border: '1px solid #000', padding: '8px' }}>
                  R{calculateTotalWithTaxAndDiscount(currentTab.items).toFixed(2)}
                </td>
              </tr>
            </tfoot>
          </table>
        ...
        {key === 'payment' && (
          <div style={{ marginBottom: '15px' }}>
            ...
            <p><strong>Amount Paid:</strong> R{parseFloat(currentTab.amount || 0).toFixed(2)}</p>
...
export default SalesOrderNewTab;