...
import PaymentNewTab from './PaymentNewTab';
...
const PaymentNewInvoice = () => {
  ...
  >
    <span style={{ fontWeight: 'bold', fontSize: '18px' }}>+</span> Create Payment
  </Button>
</div>
  ...
  <Modal show={stepModal} onHide={handleCloseModal} size="xl" centered>
    ...
    <Modal.Body>
        ...
        <PaymentNewTab         key={selectedOrder?.id || 'new'} // force remount on different order
...
export default PaymentNewInvoice;