...
const PurchaseOrderNewTab = ({ onSubmit, initialData, initialStep }) => {
                  ...
                  <Table bordered size="sm" className="dark-bordered-table">
                    <tbody>
                      <tr>
                        ...
                        <td>R{calculateTotalAmount(formData.purchaseOrder.items).toFixed(2)}</td>
                      </tr>
                      <tr>
                        <td className="fw-bold">Total:</td>
                        <td className="fw-bold">
                          R{calculateTotalAmount(formData.purchaseOrder.items).toFixed(2)}
                        </td>
                      </tr>
                    </tbody>
                  </Table>
...
export default PurchaseOrderNewTab;