...
const PurchaseQuotationNewTab = ({ onSubmit, initialData, initialStep }) => {
      ...
      >
        ...
        {key === 'payment' && (
          <div style={{ marginBottom: '15px' }}>
            ...
            <p>Amount Paid: R{parseFloat(currentTab.amount).toFixed(2)}</p>
                    ...
                    <Table bordered size="sm" className="dark-bordered-table">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            R{formData[key].items.reduce((sum, item) =>
                        ...
                        <tr>
                          ...
                          <td>
                            R{formData[key].items.reduce((sum, item) => sum + (parseFloat(item.discount) || 0), 0).toFixed(2)}
                          </td>
                        </tr>
                        <tr>
                          <td className="fw-bold">Total:</td>
                          <td className="fw-bold">
                            R{calculateTotalWithTaxAndDiscount(formData[key].items).toFixed(2)}
                          </td>
                        </tr>
                      </tbody>
                    </Table>
...
export default PurchaseQuotationNewTab;