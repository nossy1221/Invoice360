...
const BillNewTab = ({ onSubmit, initialData, initialStep }) => {
                ...
                <Table bordered size="sm" className="dark-bordered-table">
                  <tbody>
                    <tr>
                      ...
                      <td>R{calculateTotalAmount(formData.bill.items).toFixed(2)}</td>
                    </tr>
                    <tr>
                      <td className="fw-bold">Total Due:</td>
                      <td className="fw-bold">R{calculateTotalAmount(formData.bill.items).toFixed(2)}</td>
                    </tr>
                  </tbody>
                </Table>
              </Col>
