...
// ✅ Static dummy data for Vendor (Purchase Invoice)
const entry = {
  date: "2025-04-03",
  ...
  items: [
    ...
    },
    {
      ...
      taxAmt: "0.000",
      value: "75.00",
      description: "10 ROLLS - Fabric",
    },
    {
      item: "POLYESTER MIX 300GSM",
      quantity: "150.00 mtrs",
      rate: "0.250",
      discount: "0.000",
      tax: "0.000",
      taxAmt: "0.000",
      value: "37.50",
      description: "6 ROLLS - Blended Fabric",
    },
  ],
};

const VendorItemDetailsView = () => {
      ...
      {entry.items && entry.items.length > 0 ? (
        <Card className="mt-4 ">
          <Card.Header className="bg-light text-white">
            <h6 className="mb-0">Purchased Items Details</h6>
          </Card.Header>
        ...
        <Card className="mt-4">
          <Card.Body>
            <p className="text-muted text-center">
              <em>No purchased items recorded for this transaction.</em>
            </p>
          </Card.Body>
        </Card>
      )}
...
export default VendorItemDetailsView;