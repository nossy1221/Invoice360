        ...
        <Container>
          <Row className="align-items-center g-5">
            ...
            <Col xs={12} md={6} className="text-center text-md-start">
              ...
              >
                Simplify Your Accounting <br /> with Powerful Accounting
                Software
              </h1>
              <p
                className="lead mb-4"
              ...
              >
                Manage Invoicing, Inventory, Expenses & Reports — All in One
                Place
              </p>
        ...
        <Container>
          <div className="text-center mb-5">
            <h1 className="fw-bold">
              A best-in-class business management solution
            </h1>
            ...
            <Col xs={12} md={6}>
              <div className="bg-light p-4 rounded shadow-sm h-100 d-flex flex-column">
                ...
                <p className="text-center small text-muted mb-4">
                  quick | Sharp | On the Go | For You
                </p>
                <ul className="text-muted flex-grow-1">
                  <li className="mb-3">
                    <strong>Keep your money and your stock in sync.</strong>{" "}
                    Create an invoice for a sale, and watch it automatically
                    update your cash flow and deduct from your inventory. No
                    more messy spreadsheets or guesswork.
                  </li>
                  <li className="mb-3">
                    <strong>
                      Selling from your boot, your home studio, and online?
                    </strong>
                    Track stock levels for all your spots in one app. Never
                    accidentally sell that last pair of sneakers twice.
                  </li>
                  <li>
                    <strong>Share the load, not your password.</strong> Safely
                    give your cousin access to pack orders or your bookkeeper a
                    view of finances—without letting everyone see everything.
                  </li>
                </ul>
                <div className="mt-4">
                  <Button
          ...
          <Row className="g-4">
            ...
            <Col xs={12} md={6}>
              ...
              >
                ...
                <h5 className="fw-bold text-center">Stock That Never Sleeps</h5>
                <p className="text-muted text-center">
                  See your live stock levels, manage different batches (like
                  those limited-edition drops), and use your phone to scan
                  barcodes. Know what you have before you promise a customer.
                </p>
            ...
            <Col xs={12} md={6}>
              ...
              >
                ...
                <h5 className="fw-bold text-center">Money Sorted. Simple.</h5>
                <p className="text-muted text-center">
                  The app does the tricky bookkeeping for you. See if you're
                  actually making a profit this month with auto-generated
                  reports, so you can make smarter moves.
                </p>
                {/* <div className="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                  <Button
                    variant="success"
      ...
      <div style={{ backgroundColor: "#f9f9f9", padding: "30px 0" }}>
        <Container>
          <div className="text-center mb-5">
            ...
            <p className="text-muted lead">
              Streamline accounting, manage inventory, and optimize retail
              performance with tailored Accounting Enterprise features.
            </p>
          </div>
          <Row className="g-4">
            {/* Accounting Card */}
              ...
              <Card className="h-100 shadow-sm border-0">
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <Card.Text className="text-muted flex-grow-1">
                    Track income and expenses efficiently, generate detailed
                    profit & loss reports, and automate journal entries for
                    accurate financial management with our intelligent
                    accounting system.
                  </Card.Text>
                </Card.Body>
              </Card>
            ...
            <Col xs={12} md={4}>
              <Card className="h-100 shadow-sm border-0">
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <Card.Title className="fw-bold text-center text-md-start">
                    Your People, Organised
                  </Card.Title>

                  <Card.Text className="text-muted flex-grow-1">
                    Remember who owes you, who you owe, and all your past chats
                    with suppliers and clients. Build better relationships and
            ...
            <Col xs={12} md={4}>
              <Card className="h-100 shadow-sm border-0">
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <Card.Text className="text-muted flex-grow-1">
                    Monitor stock levels in real-time, manage batches and
                    expiration dates, utilize barcode scanning, and automate
                    inventory valuation using FIFO/LIFO methods for efficient
        ...
        <Container>
          <div className="text-center mb-5">
            ...
            <p
              ...
              style={{ color: "#00674b", maxWidth: "800px" }}
            >
              Get Started in Three Easy Steps. Seriously.
            </p>
          </div>
          ...
          <Row className="gy-4 justify-content-center">
            {[
              {
                step: "1",
                title: "Sign Up, Quick-Quick",
                desc: "Get going in minutes. Just your biz name and email to unlock your dashboard.",
                img: step1,
              },
              {
                step: "2",
                title: "Add Your Tribe & Your Gear",
                desc: "Pop in your regular clients and list your products or services. Get your business universe into one spot.",
                img: step2,
              },
              {
                step: "3",
                title: "Invoice & Level Up",
                desc: "Send your first professional invoice in seconds. Then, use the simple reports to see where you're winning and make your biz even stronger.",
                img: step3,
              },
            ].map((stepData, idx) => (
          ...
          <Row className="justify-content-center">
            ...
            >
              {[
                {
                  question:
                    "Can I manage customers and vendors from one dashboard?",
                  answer:
                    "Yes! Accounting's Client & Vendor Hub lets you track balances, set credit periods, and manage all transactions in one place — making relationship management effortless and organized.",
                },
                {
                  question:
                    "Does the software support multiple warehouse locations?",
                  answer:
                    "Absolutely. You can manage stock across different warehouses — track batches, set expiry dates, use barcodes, and even apply automated valuation methods like FIFO for accurate inventory control.",
                },
                {
                  question:
                    "Can I assign different access levels to my team members?",
                  answer:
                    "Yes. With Role-Based Access Control, you can define custom permissions for each user — whether they handle finance, inventory, or sales — ensuring data security while enabling smooth collaboration.",
                },
                {
                  question:
                    "Are vouchers automated or do I have to create them manually?",
                  answer:
                    "You can do both. Create vouchers manually or let the system auto-generate them with unique numbering. Every entry includes a full audit trail for transparency and easy tracking.",
                },
                {
                  question: "Can I generate real-time business reports?",
                  answer:
                    "Definitely. Get instant insights with reports on sales, inventory, cash flow, and profit & loss. All reports are visual, exportable, and updated in real time to help you make smarter decisions.",
                },
                {
                  question:
                    "Can I organize products by category, brand, and SKU?",
                  answer:
                    "Yes. Each product can be fully customized — add descriptions, set min/max stock levels, assign valuation methods, and categorize by brand or SKU for easy search and management.",
                },
              ].map((item, index) => (
                <Card
                  key={index}
                  className="mb-3 shadow-sm rounded-3 overflow-hidden border-0"
                >
                  <Card.Header
                    style={{
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0 4px 12px rgba(51, 204, 102, 0.1)";
